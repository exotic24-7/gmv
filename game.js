...
// Fallback: if the mandible asset is missing, try using the hornet sprite as a placeholder
try{ loadMobSprite('mandible', 'assets/hornet.svg', { tolerance: 40 }); }catch(e){}
try{ loadMobSprite('mandible', 'assets/hornet.png', { tolerance: 40 }); }catch(e){}
